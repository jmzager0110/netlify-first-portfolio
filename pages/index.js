    ...
    <div className="container">
      ...
      <main>
        ...
        <h1>I Do Not Know</h1>
          ...
          <a className="item" href="#job">My first job within tech</a>
          ...
          <div>
           <section id="me" className="me">
            ...
            <p className="self-text">First, let me begin by saying that I can not take myself very seriously, and that I look for humor anywhere I can find it. Let me begin by saying that you could say I was born in the darkness... As it was 4:32 AM when I was born.</p>
            <img className="meme" src="/meme.jpg" height="300" width="auto"/>
           <p className="post-meme-text" >I grew up outside Houston, Texas but ended up where I began back in Kansas City after high school. I went to a little bit of college and worked a series of just-jobs in different fields, learning a lot from each. I climbed the ranks from cashier to department manager at a hardware store, started as a receptionist at a home services company before I ended up doing the jobs in every department and of three people, then became the lead processing tech for an underwriting firm in automotive aftermarket insurance. I did tend to stay in each job for too long, and while in an extended stay in the last is when I came to the realization that I needed a career. But what? Something I had always been interested in was web development, I made a <a href="www.sullyismagic.net"> website for my dog </a> during a bout of endless health issues. My sweet husband encouraged me to consider my options, then one of our friends recommended that I look into classes offered by <a href="#school">LaunchCode.</a></p>
